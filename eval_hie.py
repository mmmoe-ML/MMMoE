...
def eval():
    ...
    output_file = f'test_predict/hie_predict_tmp.csv'
    output_cmat = f'test_predict/hie_cmat_tmp.csv'
    ...
    for i in range(5):
        ...
        _, slide_prob_B, true_label_tmp, pred_label_B, _ = get_slide_prob_label(result_B, 2)
